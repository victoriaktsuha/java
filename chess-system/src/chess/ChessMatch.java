...
public class ChessMatch {
	...
	// ChessPiece é a 'camada' de Piece que pode ser 'vista' - só a camada 'chess'
	// deve ser vista pelo programa
	public ChessPiece[][] getPieces() {
		ChessPiece[][] mat = new ChessPiece[board.getRows()][board.getColumns()];

		// percorre a matriz de peças do board e para cada peça faz um downcasting para
		// ChessPiece
